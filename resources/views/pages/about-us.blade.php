    ...
    <div class="bg-gray-800 text-white py-10">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl max-w-3xl">
                @if(session('locale') == 'sw')
                    Jifunze kuhusu Kikosi Kazi Maalum cha Kuwainua Wachimbaji Wadogo wa Madini Tanzania na dhamira yetu ya kubadilisha sekta ya uchimbaji mdogo na wa kati.
                @else
                    Learn about the Special Taskforce on Empowering Local Miners in Tanzania and our mission to transform the artisanal and small-scale mining sector.
                @endif
            </p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="prose max-w-none">
                @if(session('locale') == 'sw')
                    ...
                    <h2 class="text-2xl font-bold text-blue-800 mt-8 mb-4">Sisi ni Nani</h2>
                    <p class="mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-blue-800 mt-8 mb-4">Tunachofanya</h2>
                    ...
                    <h2 class="text-2xl font-bold text-blue-800 mt-8 mb-4">Lengo la Jukwaa Hili</h2>
                    ...
                    <h2 class="text-2xl font-bold text-blue-800 mt-8 mb-4">Ahadi Yetu</h2>
                    <p class="mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-blue-800 mt-8 mb-4">Shiriki Nasi</h2>
                    <p class="mb-6">
